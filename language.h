...
const char CLI_HELP_FOOTER[] PROGMEM = "========================================================================\r\nfor more information please visit www.pepeangell.dev\r\n========================================================================";
...
const char CLI_INFO_ADDON[] PROGMEM = "For more information please visit www.pepeangell.dev";
...
// ===== NAMES ===== //
const char N_SAVED[] PROGMEM = "Nombres de dispositivos guardados en ";
const char N_LOADED[] PROGMEM = "Nombres de dispositivos cargados de ";
const char N_REMOVED_ALL[] PROGMEM = "Se eliminaron todos los nombres guardados";
const char N_HEADER[] PROGMEM = "[===== Dispositivos Guardados =====]";
const char N_TABLE_HEADER[] PROGMEM =  "ID MAC             Fabricante   Nombre            AP-BSSID          Ch Selec.";
const char N_TABLE_DIVIDER[] PROGMEM = "============================================================================";
const char N_ERROR_LIST_EMPTY[] PROGMEM = "La lista de nombres está vacía :(";
const char N_ERROR_NO_SELECTED[] PROGMEM = "No hay dispositivos seleccionados";
const char N_ERROR_LIST_FULL[] PROGMEM = "ERROR: ¡La lista de nombres está llena!";
const char N_ADDED[] PROGMEM = "Añadido a la lista de nombres ";
const char N_REPLACED[] PROGMEM = "Lista de nombres reemplazada ";
const char N_REMOVED[] PROGMEM = "Eliminado de la lista de nombres ";
const char N_CHANGED_NAME[] PROGMEM = "Nombre de dispositivo cambiado";
const char N_CHANGED_MAC[] PROGMEM = "MAC de dispositivo cambiada";
const char N_CHANGED_BSSID[] PROGMEM = "AP-BSSID de dispositivo cambiado";
const char N_CHANGED_CH[] PROGMEM = "Canal de dispositivo cambiado";
const char N_SELECTED[] PROGMEM = "Dispositivo seleccionado ";
const char N_ERROR_NOT_FOUND[] PROGMEM = "No se encontró dispositivo con el nombre ";
const char N_DESELECTED[] PROGMEM = "Dispositivo deseleccionado ";
const char N_SELECTED_ALL[] PROGMEM = "Todos los nombres seleccionados";
const char N_DESELECTED_ALL[] PROGMEM = "Todos los nombres deseleccionados";
...
const char SS_JSON_DEFAULT[] PROGMEM = "{\"random\":false,\"ssids\":[[\"💥El_Diablo_Te_Bendiga\",false,23],[\"🤖Amlo_es_Puto\",false,24],[\"🧠Sheinbaum_se_la_come\",false,22],[\"⚠️Puto_el_que_lo_lea\",false,24],[\"😱Porno_homosexual\",false,23],[\"📡Ey_Tu_La_De_Negro\",false,22],[\"😈Wifi_Gratis\",false,20],[\"👹Eres_Un_Pendejo\",false,22]]}";
