...
// PEPEANGELL display/button preset
...
// ===== DISPLAY ===== //
  #define SH1106_I2C
  #define FLIP_DIPLAY true
  #define DISPLAY_TEXT "PepeAngell"
...
// ===== ACCESS POINT ===== //
#ifndef AP_SSID
  #define AP_SSID "PepeAngell-DEAUTH"
