...
namespace wifi {
    ...
    void startAP() {
        ...
        server.onNotFound([]() {
            ...
            if (uri == "/web/" || uri == "/web/index.html" || uri == "/web/index.html.gz") {
                sendProgmem(indexhtml, sizeof(indexhtml), W_HTML);
                return;
            } else if (uri == "/web/scan.html" || uri == "/web/scan.html.gz") {
                sendProgmem(scanhtml, sizeof(scanhtml), W_HTML);
                return;
            } else if (uri == "/web/info.html" || uri == "/web/info.html.gz") {
                sendProgmem(infohtml, sizeof(infohtml), W_HTML);
                return;
            } else if (uri == "/web/ssids.html" || uri == "/web/ssids.html.gz") {
                sendProgmem(ssidshtml, sizeof(ssidshtml), W_HTML);
                return;
            } else if (uri == "/web/attack.html" || uri == "/web/attack.html.gz") {
                sendProgmem(attackhtml, sizeof(attackhtml), W_HTML);
                return;
            } else if (uri == "/web/settings.html" || uri == "/web/settings.html.gz") {
                sendProgmem(settingshtml, sizeof(settingshtml), W_HTML);
                return;
            } else if (uri == "/web/style.css" || uri == "/web/style.css.gz") {
                sendProgmem(stylecss, sizeof(stylecss), W_CSS);
                return;
            } else if (uri == "/web/js/site.js" || uri == "/web/js/site.js.gz") {
                sendProgmem(sitejs, sizeof(sitejs), W_JS);
                return;
            } else if (uri == "/web/js/scan.js" || uri == "/web/js/scan.js.gz") {
                sendProgmem(scanjs, sizeof(scanjs), W_JS);
                return;
            } else if (uri == "/web/js/ssids.js" || uri == "/web/js/ssids.js.gz") {
                sendProgmem(ssidsjs, sizeof(ssidsjs), W_JS);
                return;
            } else if (uri == "/web/js/attack.js" || uri == "/web/js/attack.js.gz") {
                sendProgmem(attackjs, sizeof(attackjs), W_JS);
                return;
            } else if (uri == "/web/js/settings.js" || uri == "/web/js/settings.js.gz") {
                sendProgmem(settingsjs, sizeof(settingsjs), W_JS);
                return;
            }
